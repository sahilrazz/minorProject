...
The notebook, model and documentation(Dockerfiles, FastAPI script, Streamlit App script) are available on [GitHub.](https://github.com/sahil-razz/Credit-Card-Fraud-Detection)        

**Made by Sahil Kumar, Satkirat Singh, Abhishek Singh**

**Contributors:** 
- **SAHIL KUMAR UID - 23MCC20115 (Group Lead)**
- **SATKIRAT SINGH  - 23MCC20101**
- **ABHISHEK SINGH  - 23MCC20115**
